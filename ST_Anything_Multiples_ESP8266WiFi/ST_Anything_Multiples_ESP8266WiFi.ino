...
#define PIN_CONTACT_1             D5  //SmartThings Capabilty "Contact Sensor"
#define PIN_CONTACT_1             D6  
#define PIN_BUTTON_1              D7  //SmartThings Capabilty Button / Holdable Button (Normally Open!)
#define PIN_BUTTON_2              D8  //SmartThings Capabilty Button / Holdable Button (Normally Open!)
#define PIN_TEMPERATURE_1         3  //SmartThings Capabilty "Temperature Measurement" (Dallas Semiconductor DS18B20)
#define PIN_TEMPERATURE_2         1
//******************************************************************************************
//ESP8266 WiFi Information
//******************************************************************************************
String str_ssid     = "MicroLab";                           //  <---You must edit this line!
String str_password = "microp4ss";                   //  <---You must edit this line!
IPAddress ip(192, 168, 1, 211);       //Device IP Address       //  <---You must edit this line!
...
IPAddress hubIp(192, 168, 1, 13);    // smartthings hub ip     //  <---You must edit this line!
...
void setup()
{
  ...
  static st::PS_DS18B20_Temperature sensor2(F("temperature2"), 15, 0, PIN_TEMPERATURE_2, false, 10, 1); 
  ...
  static st::EX_Switch executor5(F("switch4"), PIN_SWITCH_4, LOW, true);  //Inverted logic for "Active Low" Relay Board
